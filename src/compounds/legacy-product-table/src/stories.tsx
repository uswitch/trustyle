...
export const Example = () => {
  return (
    <LegacyProductTable>
      <DataCell backgroundColor="#fef6ed" borderBottomColor="#fcdbb7">
        <strong>Loan amount</strong>
        <br />
        £1,000 to £10,000
      </DataCell>

      <DataCell backgroundColor="#fef1ec" borderBottomColor="#fac9b0">
        <strong>Representative APR</strong>
        <br />
        29% APR (£1,000 to £10,000)
      </DataCell>

      <DataCell backgroundColor="#fbedf1" borderBottomColor="#f0b9c8">
