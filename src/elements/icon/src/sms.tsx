...
export const Sms: React.FC<Props> = ({ color, size }) => (
  <svg css={css([st.icon, st.size(size)])} viewBox="0 0 36 32">
    <defs>
      <path
        id="4bba07c2-13da-4282-84d6-8ad56e5ba905"
    ...
    <g fill="none" fillRule="evenodd" transform="translate(.75)">
      <mask id="8eaae52e-08a4-4f37-9808-fc288f0f5e16" fill="#fff">
        <use xlinkHref="#4bba07c2-13da-4282-84d6-8ad56e5ba905" />
      </mask>
      <use fill="#000" fillRule="nonzero" xlinkHref="#4bba07c2-13da-4282-84d6-8ad56e5ba905" />
      <g fill={color} mask="url(#8eaae52e-08a4-4f37-9808-fc288f0f5e16)">
        <ellipse
          cx="26.5"
          cy="23"
          rx="26.5"
