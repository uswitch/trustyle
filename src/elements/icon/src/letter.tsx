...
export const Letter: React.FC<Props> = ({ color, size }) => (
  <svg css={css([st.icon, st.size(size)])} viewBox="0 0 36 32">
    <defs>
      <path
        id="383cc87b-21fa-4431-b28a-cac1b5ed54d0"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="e2f06c65-ab6e-4a89-a838-e71086a47ccc" fill="#fff">
        <use xlinkHref="#383cc87b-21fa-4431-b28a-cac1b5ed54d0" />
      </mask>
      <use fill="#000" fillRule="nonzero" xlinkHref="#383cc87b-21fa-4431-b28a-cac1b5ed54d0" />
      <g fill={color} mask="url(#e2f06c65-ab6e-4a89-a838-e71086a47ccc)">
        <ellipse
          cx="27.5"
          cy="23"
          rx="26.5"
